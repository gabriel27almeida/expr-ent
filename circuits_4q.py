...
circuits.append(VariationalCircuit("1", circ1, 4, 8, 0, 2))
...
circuits.append(VariationalCircuit("2", circ2, 4, 8, 3, 5))
...
circuits.append(VariationalCircuit("3", circ3, 4, 11,3,5))
...
circuits.append(VariationalCircuit("4", circ4, 4, 11,3,5))
...
circuits.append(VariationalCircuit("5", circ5, 4, 28, 12,16))
...
circuits.append(VariationalCircuit("6", circ6, 4, 28,12,16))
...
circuits.append(VariationalCircuit("7", circ7, 4, 19,3,6))
...
circuits.append(VariationalCircuit("8", circ8, 4, 19,3,6))
...
circuits.append(VariationalCircuit("9", circ9, 4, 4,3,5))
...
circuits.append(VariationalCircuit("10", circ10, 4, 4,4,5))
...
circuits.append(VariationalCircuit("11", circ11, 4, 12,3,6))
...
circuits.append(VariationalCircuit("12", circ12, 4, 12,3,6))
...
circuits.append(VariationalCircuit("13", circ13, 4, 16,8,10))
...
circuits.append(VariationalCircuit("14", circ14, 4, 16,8,10))
...
circuits.append(VariationalCircuit("15", circ15, 4, 8, 8, 10))
...
circuits.append(VariationalCircuit("16", circ16, 4, 11,3,4))
...
circuits.append(VariationalCircuit("17", circ17, 4, 11,3,4))
...
circuits.append(VariationalCircuit("18", circ18, 4, 12,4,6))
...
circuits.append(VariationalCircuit("19", circ19, 4, 12,4,6))
