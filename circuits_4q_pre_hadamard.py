...
circuits.append(VariationalCircuit("1-preh", circ1, 4, 8))
...
circuits.append(VariationalCircuit("2-preh", circ2, 4, 8))
...
circuits.append(VariationalCircuit("3-preh", circ3, 4, 11))
...
circuits.append(VariationalCircuit("4-preh", circ4, 4, 11))
...
circuits.append(VariationalCircuit("5-preh", circ5, 4, 28))
...
circuits.append(VariationalCircuit("6-preh", circ6, 4, 28))
...
circuits.append(VariationalCircuit("7-preh", circ7, 4, 19))
...
circuits.append(VariationalCircuit("8-preh", circ8, 4, 19))
...
circuits.append(VariationalCircuit("9-preh", circ9, 4, 4))
...
circuits.append(VariationalCircuit("10-preh", circ10, 4, 4))
...
circuits.append(VariationalCircuit("11-preh", circ11, 4, 12))
...
circuits.append(VariationalCircuit("12-preh", circ12, 4, 12))
...
circuits.append(VariationalCircuit("13-preh", circ13, 4, 16))
...
circuits.append(VariationalCircuit("14-preh", circ14, 4, 16))
...
circuits.append(VariationalCircuit("15-preh", circ15, 4, 8))
...
circuits.append(VariationalCircuit("16-preh", circ16, 4, 11))
...
circuits.append(VariationalCircuit("17-preh", circ17, 4, 11))
...
circuits.append(VariationalCircuit("18-preh", circ18, 4, 12))
...
circuits.append(VariationalCircuit("19-preh", circ19, 4, 12))
